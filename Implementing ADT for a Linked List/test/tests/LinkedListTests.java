/**
 * This class runs methods to test all methods in SLL.java
 * @author Madhu
 * @version 7/26/2021
 */
...
class LinkedListTests {
	 ...
	 */
	@BeforeEach
	void setUp() throws Exception {// Create your concrete linked list class and assign to to linkedList.
	...
	/**
	 * Tests if a node contains an element in the linked list
	 * @author Jenny 
	 */
	@Test
	void testListContainsNode()
	{
		this.linkedList.clear();
		this.linkedList.append("a");
		this.linkedList.append("b");
	...
	/**
	 * Tests the index of an element in a node in the linked list
	 * @author Jenny 
	 */
	...
	/**
	 * Tests the retrieval of an element in a node in the linked list
	 * @author Jenny 
	 */
	@Test
	void testRetreiveElementFromNodeAtIndex()
	{
		this.linkedList.clear();
		this.linkedList.append("a");
		this.linkedList.append("b");
	...
	/**
	 * Tests the append and prepend methods and then checks element in a node in the linked list
	 * @author Jenny 
	 */
	@Test
	void testAppendPrependCheckElementAtIndex()
	{
		this.linkedList.clear();
		this.linkedList.append("a");
		this.linkedList.append("b");
		this.linkedList.prepend("x");
		this.linkedList.prepend("y");
		this.linkedList.prepend("z");
		
		String value = (String) this.linkedList.retrieve(1);
		assertEquals("y", value);
	}
	/**
	 * Tests clear the linked list
	 * @author Jenny 
	 */
