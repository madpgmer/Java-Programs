...
public class MyArrayListTests {
	...
	public final void testAddStringTToIndex() {
		...
		boolean expected = true;
		boolean actual = myList.add(1, three);
		String expectedString = "Three";
		String actualString = (myList.get(1)).toString();
		String expectedString2 = "One";
		String actualString2 = (myList.get(2)).toString();
	...
	public final void testAddAll() {
		...
		MyArrayList myOtherList = new MyArrayList<String>();
	...
	public final void testRemoveItemfromIndex() {
		...
		assertEquals("Size is incorrect", myList.size(), 1); 			
	}
	...
	public final void testRemoveT() {
		...
		String expectedString = "One";
		String actualString = myList.remove("One").toString();
	...
	public final void testSet() {
		...
		String expectedString = "Two";
		String actualString = myList.set(2, "Four");
		String expectedAddedString = "Four";
		String actualAddedString = myList.get(2);
...
//		testArray[1] = five;
	...
	public final void testToArrayTArrayNullPointerException() {
		...
		try {
			...
			fail("ArrayList converted to NULL [] Array was not correct");
		} catch (NullPointerException e) {
			assertTrue(true);
		}		
	}
